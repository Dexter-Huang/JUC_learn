...
public final class BenchmarkLocks_b {
    ...
    public Collection<? extends Result> b_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            BenchmarkLocks_1_jmh l_benchmarklocks0_0 = _jmh_tryInit_f_benchmarklocks0_0(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                l_benchmarklocks0_0.b();
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            b_thrpt_jmhLoop(control, res, l_benchmarklocks0_0, l_blackhole1_1);
    ...
    public void b_thrpt_jmhLoop(InfraControl control, RawResults result, BenchmarkLocks_1_jmh l_benchmarklocks0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> b_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            b_avgt_jmhLoop(control, res, l_benchmarklocks0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void b_avgt_jmhLoop(InfraControl control, RawResults result, BenchmarkLocks_1_jmh l_benchmarklocks0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> b_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            b_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_benchmarklocks0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_benchmarklocks0_0.b();
    ...
    public void b_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, BenchmarkLocks_1_jmh l_benchmarklocks0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> b_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            b_ss_jmhStub(control, batchSize, res, l_benchmarklocks0_0, l_blackhole1_1);
                control.preTearDown();
            if (l_blackhole1_1.readyIteration) {
                l_blackhole1_1.readyIteration = false;
            }
    ...
    public void b_ss_jmhStub(InfraControl control, int batchSize, RawResults result, BenchmarkLocks_1_jmh l_benchmarklocks0_0, Blackhole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    BenchmarkLocks_1_jmh f_benchmarklocks0_0;
    
    BenchmarkLocks_1_jmh _jmh_tryInit_f_benchmarklocks0_0(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (f_benchmarklocks0_0 == null) {
            BenchmarkLocks_1_jmh val = new BenchmarkLocks_1_jmh();
            val.readyTrial = true;
            f_benchmarklocks0_0 = val;
        }
        return f_benchmarklocks0_0;
    }
    ...
    static class BenchmarkLocks_1_jmh_B1 extends com.itcast.BenchmarkLocks {
    ...
    static class BenchmarkLocks_1_jmh_B2 extends BenchmarkLocks_1_jmh_B1 {
        public volatile int setupTrialMutex;
        public volatile int tearTrialMutex;
        public final static AtomicIntegerFieldUpdater setupTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkLocks_1_jmh_B2.class, "setupTrialMutex");
        public final static AtomicIntegerFieldUpdater tearTrialMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkLocks_1_jmh_B2.class, "tearTrialMutex");
    
        public volatile int setupIterationMutex;
        public volatile int tearIterationMutex;
        public final static AtomicIntegerFieldUpdater setupIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkLocks_1_jmh_B2.class, "setupIterationMutex");
        public final static AtomicIntegerFieldUpdater tearIterationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkLocks_1_jmh_B2.class, "tearIterationMutex");
    
        public volatile int setupInvocationMutex;
        public volatile int tearInvocationMutex;
        public final static AtomicIntegerFieldUpdater setupInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkLocks_1_jmh_B2.class, "setupInvocationMutex");
        public final static AtomicIntegerFieldUpdater tearInvocationMutexUpdater = AtomicIntegerFieldUpdater.newUpdater(BenchmarkLocks_1_jmh_B2.class, "tearInvocationMutex");
    ...
    static class BenchmarkLocks_1_jmh_B3 extends BenchmarkLocks_1_jmh_B2 {
    ...
    static final class BenchmarkLocks_1_jmh extends BenchmarkLocks_1_jmh_B3 {
    }
